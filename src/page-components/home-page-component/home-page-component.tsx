        ...
        <div className={styles.home}>
            ...
            <div className={styles.hero}>
                <div className={styles.heroTitle}>
                    <Heading tag="h1">Lern New Skills Online</Heading>
                    <Text>
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Nihil nulla adipisci temporibus ad, veniam blanditiis optio voluptatibus eius
                        id, eaque, ex aperiam quam voluptatum deleniti quos? Quis voluptatum rem quaerat.
                    </Text>
